...
@section('content')
	...
	<section class="section">
		...
		<div class="section-header">
			...
			<h1>{{ __('installer_messages.links') }}</h1>
							...
							<div class="card-body">
								...
								<ul class="nav nav-pills flex-column">
									...
									<li class="nav-item">
										...
										<a class="nav-link{{$type == '' ? ' active' : ''}}" href="{{ route_type('links.index') }}" style="text-align: right;">

											<i class="fas fa-list"></i> {{ __('installer_messages.all links') }}
									...
									<li class="nav-item">
										...
										<a class="nav-link has-icon{{$t == $type ? ' active' : ''}}" href="{{ route_type('links.index',['type' => $t]) }}" style="text-align: right;">

											<i class="{{ $link['icon'] }}"></i>

											{{ __('installer_messages.' . strtolower($link['text'])) }}
					...
					<div class="col-lg-9">
						...
						<div class="card card-primary">
							...
							<div class="card-header">
								...
								<h4>{{ __('installer_messages.links') }}</h4>
								...
								<div class="card-header-action">
									...
									<div class="dropdown">
										...
										<a href="#" class="btn btn-primary btn-lg btn-icon icon-left has-dropdown dropdown-toggle" data-toggle="dropdown">
											...
											<i class="fas fa-link"></i> {{ __('installer_messages.create new link') }}
										...
										<div class="dropdown-menu">
											...
											<a href="{{route_type('links.create', ['type' => $t])}}" class="dropdown-item" style="text-align: right;">
												{{ __('installer_messages.' . strtolower($link['text'])) }}
											</a>
								...
								<div class="table table-responsive">
									...
									<table class="table table-striped">
										...
										<tr style="text-align: center;">
											...
											<th>{{ __('installer_messages.phone number') }}</th>

											<th>{{ __('installer_messages.hit') }}</th>

											<th>{{ __('installer_messages.type') }}</th>

											<th>{{ __('installer_messages.created at') }}</th>

											<th>{{ __('installer_messages.action') }}</th>
										...
										<tr>
											...
											<td colspan="6" class="text-center">{{ __('installer_messages.no data') }}</td>
